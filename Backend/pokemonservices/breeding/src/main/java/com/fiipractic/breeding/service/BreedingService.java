...
public class BreedingService {
    ...
    public void breed(Integer pokeId1,Integer pokeId2, Model model){
        ...
        Egg hatchEgg = eggRepository.findOneByPokemon1AndPokemon2AndStatus(pokeId1,pokeId2, EggStatus.HATCHED);

        Boolean combinationExists = false;
        if(pendingEgg == null && hatchEgg == null){
            createEgg(pokemon1, pokemon2);
        } else if(hatchEgg != null){
